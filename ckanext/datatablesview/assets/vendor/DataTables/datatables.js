...
// This file has been modified to correct two issues when used with FMLD - look for comments containing FMLD mod for details
...
(function (factory) {
  ...
  DataTable.ext = _ext = {
     ...
     */
    build:
      "bs5/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/fc-4.1.0/kt-2.7.0/r-2.3.0/sl-1.4.0",
  ...
  $.extend(Responsive.prototype, {
    ...
    _resize: function (forceRedraw) {
      ...
      if (changed) {
        ...
        /*
      FMLD mod -  Removed the following lines to fix rendering issue
      ...
      if (!$.fn.modal) {
        ...
        if (!update) {
          if (options && options.header) {
            ...
            var button = header.find("button.btn-close").detach(); // FMLD mod - only remove the close button (leave the ones generated by FMLD)
