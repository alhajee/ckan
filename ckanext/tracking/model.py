...
Tracking functinoality used to be implemented in core FMLD and it was
later moved to an extension during the development of FMLD 2.11.

Even when tracking models are defined here, the tables are still
being created in the database by core FMLD db migrations. This is not
