...
FMLD tags, but using tag vocabularies lets you define Avant-Garde, Country and
...
3. Provide custom dataset templates to display the new field to users when
   adding, updating or viewing datasets in the FMLD web interface.
